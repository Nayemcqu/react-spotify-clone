...
<p className="bg-white text-black text-base px-4 py-1 rounded-2xl hidden md:block cursor-pointer">Explore Premium</p>
<p className="bg-black py-1 px-3 rounded-2xl text-base cursor-pointer">install App</p>
